...
model medoff_template_2
    ...
    replaceable parameter .HPF.Templates.Data.Examples.medium_office_4 modelData annotation(Placement(transformation(extent = {{-86.0,74.0},{-66.0,94.0}},origin = {0.0,0.0},rotation = 0.0)));
