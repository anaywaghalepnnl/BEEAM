...
model medoff_template_3
    ...
    replaceable parameter .HPF.Templates.Data.Examples.medium_office_light_mel_1 modelData annotation(Placement(transformation(extent = {{-86.0,74.0},{-66.0,94.0}},origin = {0.0,0.0},rotation = 0.0)));
    
    .HPF.Templates.LoadwStepDown_woCTT lum_phaseA[modelData.nStepDown_lumA](redeclare replaceable .HPF.DC.DC2DC_Converters.DummyShort dcdc_Converter, modelData=
    ...
    .HPF.Templates.LoadwStepDown_woCTT lum_phaseB[modelData.nStepDown_lumB](redeclare replaceable .HPF.DC.DC2DC_Converters.DummyShort dcdc_Converter, modelData=
    ...
    .HPF.Templates.LoadwStepDown_woCTT lum_phaseC[modelData.nStepDown_lumC](redeclare replaceable .HPF.DC.DC2DC_Converters.DummyShort dcdc_Converter, modelData=
    ...
    .HPF.Templates.LoadwStepDown mel_phaseA[modelData.nStepDown_melA](redeclare replaceable .HPF.DC.DC2DC_Converters.DummyShort dcdc_Converter, modelData=
    ...
    .HPF.Templates.LoadwStepDown mel_phaseB[modelData.nStepDown_melB](redeclare replaceable .HPF.DC.DC2DC_Converters.DummyShort dcdc_Converter, modelData=
    ...
    .HPF.Templates.LoadwStepDown mel_phaseC[modelData.nStepDown_melC](redeclare replaceable .HPF.DC.DC2DC_Converters.DummyShort dcdc_Converter, modelData=
    ...
    .HPF.Templates.ACload aCload(aC_LoadIdealWye(P_nom = 100,V_nom = 277),ac_schedule(tableName = "Mechanical",fileName = .ModelicaServices.ExternalReferences.loadResource("modelica://PrototypeBuildingElectricalModels/Data/LoadProfiles/San-Diego-Mechanical_LP.txt"),timeScale = 3600)) annotation(Placement(transformation(extent = {{10.0,-10.0},{-10.0,10.0}},origin = {-14.571428571428573,59.71428571428572},rotation = 90.0)));
    .HPF.Data.SingleFileMultiTable singleFileMultiTable annotation(Placement(transformation(extent = {{126.0,-120.0},{146.0,-100.0}},origin = {0.0,0.0},rotation = 0.0)));
equation
        for i in 1:nconverter_lumA loop
            ...
            connect(singleFileMultiTable.y[1],lum_phaseA[i].u) annotation(Line(points = {{133.6,-107.2},{133.6,-101.2},{124.6,-101.2},{124.6,26.8},{130.6,26.8}},color = {0,0,127}));
         end for;
        ...
        for i in 1:nconverter_lumB loop
            ...
            connect(singleFileMultiTable.y[2],lum_phaseB[i].u) annotation(Line(points = {{133.6,-107.2},{133.6,-101.2},{124.6,-101.2},{124.6,26.8},{130.6,26.8}},color = {0,0,127}));
         end for;
         ...
         for i in 1:nconverter_lumC loop
            ...
            connect(singleFileMultiTable.y[3],lum_phaseC[i].u) annotation(Line(points = {{133.6,-107.2},{133.6,-101.2},{124.6,-101.2},{124.6,26.8},{130.6,26.8}},color = {0,0,127}));
         end for;
